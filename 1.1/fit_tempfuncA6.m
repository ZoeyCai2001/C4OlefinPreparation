...
%    工作表: 性能数据表
%
% 由 MATLAB 于 2021-09-10 10:02:47 自动生成
...
% 导入数据
A6 = readtable("D:\2021国赛\CUMCM2021Probelms\B\附件1.xlsx", opts, "UseExcel", false);


%% 清除临时变量
clear opts
%%
A6array = table2array(A6);
A6temp = A6array(:,1);
A6yichun = A6array(:,2);
A6c4 = A6array(:,3);
%% Initialization.
...
%% Fit: 'A6temp-乙醇'.
[xData, yData] = prepareCurveData( A6temp, A6yichun );
...
% Plot fit with data.
figure( 'Name', 'A6temp-乙醇' );
h = plot( fitresult{1}, xData, yData );
legend( h, 'A6yichun vs. A6temp', 'A6temp-乙醇', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
...
%% Fit: 'A6temp-c4'.
[xData, yData] = prepareCurveData( A6temp, A6c4 );
...
% Plot fit with data.
figure( 'Name', 'A6temp-c4' );
h = plot( fitresult{2}, xData, yData );
legend( h, 'A6c4 vs. A6temp', 'A6temp-c4', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( '温度', 'Interpreter', 'none' );
