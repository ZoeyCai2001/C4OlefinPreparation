...
%    工作表: 性能数据表
%
% 由 MATLAB 于 2021-09-10 10:38:41 自动生成
...
% 导入数据
A8 = readtable("D:\2021国赛\CUMCM2021Probelms\B\附件1.xlsx", opts, "UseExcel", false);


%% 清除临时变量
clear opts
%%
A8array = table2array(A8);
A8temp = A8array(:,1);
A8yichun = A8array(:,2);
A8c4 = A8array(:,3);
%% Initialization.
...
%% Fit: 'A8temp-乙醇'.
[xData, yData] = prepareCurveData( A8temp, A8yichun );
...
% Plot fit with data.
figure( 'Name', 'A8temp-乙醇' );
h = plot( fitresult{1}, xData, yData );
legend( h, 'A8yichun vs. A8temp', 'A8temp-乙醇', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
...
%% Fit: 'A8temp-c4'.
[xData, yData] = prepareCurveData( A8temp, A8c4 );
...
% Plot fit with data.
figure( 'Name', 'A8temp-c4' );
h = plot( fitresult{2}, xData, yData );
legend( h, 'A8c4 vs. A8temp', 'A8temp-c4', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( '温度', 'Interpreter', 'none' );
